...
import { BarChartOutlined, DatabaseOutlined, FileTextOutlined, RadarChartOutlined } from '@ant-design/icons-vue';
import { api, type Brand, type Detection, type Prompt, type VisibilitySummary } from './api';
